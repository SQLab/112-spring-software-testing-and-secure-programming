...
test('Test MailSystem write', () => {
    test('MailSystem write', (t) => {
        ...
        const MSwName = 'tingegg';
    
        context = MSw.write(MSwName);
        assert.strictEqual(context, 'Congrats, tingegg!', 'Error Name');
    
        context = MSw.write(null);
        assert.strictEqual(context, 'Congrats, null!', 'Error null');
    
        context = MSw.write(123);
        assert.strictEqual(context, 'Congrats, 123!', 'Error 123');
